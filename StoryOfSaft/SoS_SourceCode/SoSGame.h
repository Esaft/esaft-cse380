...
static const wstring SoS_SPLASH_SCREEN_PATH	= L"textures/gui/overlays/spiked_acid_splash_screen_overlay.png";
static const wstring SoS_MAIN_MENU_PATH		= L"textures/gui/overlays/spiked_acid_main_menu_overlay.png";
