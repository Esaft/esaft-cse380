...
static const wstring	SoS_BOT_INIT_FILE		= L"data/botInfo.csv";
...
static const wstring SoS_ABOUT_COMMAND		= L"About Menu";
static const wstring SoS_CONTROLS_COMMAND	= L"Controls Menu";
