/*
	...
	DummyTextGenerator.cpp

	See DummyTextGenerator.h for a class description.
*/
...
*/
void DummyTextGenerator::appendTargetFPS(Game *game)
{
...
*/
void DummyTextGenerator::updateText(Game *game)
{
